...
public class InstanceClass {
    ...
    public TestClass[] testClassArrayField = new TestClass[10];
    ...
    @Keep
    TestClass[] getTestClassArray() {
        return testClassArrayField;
    }
    ...
    @Keep
    void setTestClassArray(TestClass[] val) {
        testClassArrayField = val;
    }
}
